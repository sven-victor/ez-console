...
i18n.addResourceBundle('en', 'translation', enProduct, true, true);
i18n.addResourceBundle('zh-CN', 'translation', zhProduct, true, true);
```
...
const errorMessages = {
  ...
  'E4291': t('errors.rateLimit'),
  'E4292': t('errors.quotaExceeded'),
