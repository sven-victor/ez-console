...
type InitProjectOptions struct {
	...
	EzConsoleGoMod string // require version e.g. v1.15.0
	EzConsoleNPM   string // npm semver e.g. ^1.15.0 (derived from EzConsoleGoMod if empty)
