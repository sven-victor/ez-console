...
type InitProjectOptions struct {
	...
	EzConsoleGoMod string // require version e.g. v1.16.0
	EzConsoleNPM   string // npm semver e.g. ^1.16.0 (derived from EzConsoleGoMod if empty)
