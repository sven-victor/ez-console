...
type InitProjectOptions struct {
	...
	EzConsoleGoMod string // require version e.g. v1.18.0
	EzConsoleNPM   string // npm semver e.g. ^1.18.0 (derived from EzConsoleGoMod if empty)
