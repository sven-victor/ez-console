...
type InitProjectOptions struct {
	...
	EzConsoleGoMod string // require version e.g. v1.19.1
	EzConsoleNPM   string // npm semver e.g. ^1.19.1 (derived from EzConsoleGoMod if empty)
