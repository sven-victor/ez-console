    ...
    "paths": {
        ...
        "/api/system/skills": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter by built-in flag (true = preset only, false = user skills only; omit for all)",
                        "name": "is_preset",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/util.PaginationResponse-model_Skill"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/systemapi.CreateSkillRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/util.Response-array_string"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/system/skills/upload": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Skill file (.md or .zip)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/systemapi.UpdateSkillRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/systemapi.CreateSkillDirRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/system/skills/{id}/files": {
            "get": {
                ...
                "operationId": "listSkillFilesTree",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Skill ID",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/util.Response-array_service_SkillTreeNode"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/system/skills/{id}/files/{path}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "File path (e.g. SKILL.md or docs/readme.md)",
                        "name": "path",
                        "in": "path",
                        "required": true
                    }
        ...
        "/api/system/skills/{id}/move-path": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "From and to paths",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/systemapi.MoveSkillPathRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/system/task-settings/log-storage-backends": {
            "get": {
                ...
                "operationId": "listLogStorageBackends",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/util.Response-array_model_LogStorageBackendOption"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/system/toolsets/{id}/status": {
            "put": {
                ...
                "operationId": "updateToolSetStatus",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Toolset ID",
                    ...
                    {
                        "description": "Update toolset status request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/util.Response-array_service_ScheduledJobState"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/task-schedules/{id}/history": {
            "get": {
                ...
                "operationId": "getTaskScheduleHistory",
                "parameters": [
                    {
                        "type": "string",
        ...
        "/api/task-schedules/{id}/toggle": {
            "post": {
                ...
                "operationId": "toggleTaskSchedule",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Schedule ID",
        ...
        "/api/task-schedules/{id}/trigger": {
            "post": {
                ...
                "operationId": "triggerTaskSchedule",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Schedule ID",
    ...
    "definitions": {
        ...
        "aiapi.SendMessageRequest": {
            ...
            "properties": {
                ...
                "skill_ids": {
                    "description": "optional: load these specific skills by id",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "model.LogStorageBackendOption": {
            ...
            "properties": {
                "id": {
                    "description": "Backend name (e.g. \"database\")",
                    "type": "string"
                },
                "name": {
        ...
        "model.Role": {
            ...
            "properties": {
                ...
                "role_type": {
                    "description": "RoleType: \"system\" = created by seed/default-role assignment, not user-manageable; \"user\" = user-created",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "model.Task": {
            ...
            "properties": {
                ...
                "cron_schedule_id": {
                    "description": "set when task was created by a scheduled job",
                    "type": "string"
                },
                "error": {
                    "type": "string"
        ...
        "service.SkillTreeNode": {
            ...
            "properties": {
                "children": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.SkillTreeNode"
                    }
                },
                "is_dir": {
                    "type": "boolean"
        ...
        "systemapi.CreateSkillDirRequest": {
            "type": "object",
            "required": [
                "path"
            ],
        ...
        "systemapi.CreateSkillRequest": {
            ...
            "properties": {
                ...
                "content": {
                    "description": "optional initial SKILL.md content",
                    "type": "string"
                },
                "description": {
                    "type": "string"
        ...
        "systemapi.MoveSkillPathRequest": {
            "type": "object",
            "required": [
                "from_path",
                "to_path"
        ...
        "util.PaginationResponse-model_Skill": {
            "type": "object",
            "required": [
                "code",
                "current",
        ...
        "util.Response-array_model_LogStorageBackendOption": {
            "type": "object",
            "required": [
                "code",
                "data",
            ...
            "properties": {
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.LogStorageBackendOption"
                    }
                },
                "err": {
                    "type": "string"
        ...
        "util.Response-array_service_ScheduledJobState": {
            "type": "object",
            "required": [
                "code",
                "data",
            ...
            "properties": {
                ...
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.ScheduledJobState"
                    }
                },
                "err": {
                    "type": "string"
