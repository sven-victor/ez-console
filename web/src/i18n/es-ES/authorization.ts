...
export default {
  ...
  mfa: {
    ...
    enterTotpCode: 'O introduce el código de 6 dígitos de tu aplicación de autenticación',
    passwordOrCodeRequired: 'Por favor, introduce tu contraseña o un código de verificación',
    totp: 'TOTP',
    email: 'Correo electrónico',
