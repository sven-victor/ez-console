...
export default {
  ...
  mfa: {
    ...
    enterTotpCode: 'Oder geben Sie den 6-stelligen Code aus Ihrer Authenticator-App ein',
    passwordOrCodeRequired: 'Bitte geben Sie Ihr Passwort oder einen Bestätigungscode ein',
    totp: 'TOTP',
    email: 'E-Mail',
