...
export default {
  ...
  mfa: {
    ...
    enterTotpCode: 'Ou saisissez le code à 6 chiffres de votre application d\'authentification',
    passwordOrCodeRequired: 'Veuillez saisir votre mot de passe ou un code de vérification',
    totp: 'TOTP',
    email: 'E-mail',
