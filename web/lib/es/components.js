...
import { Spin as fe, Result as q, Dropdown as re, Avatar as je, Upload as ye, Modal as O, Popover as ve, List as we, Divider as ae, Skeleton as be, Button as v, Popconfirm as H, Tooltip as Se, Space as L, Input as b, Table as W, Form as x, message as w, Card as E, Segmented as Ie, Steps as Ce, Alert as Q, QRCode as ke, Typography as Fe, Tag as R, Empty as Le, Row as X, Col as M, Select as T, DatePicker as Ae, Checkbox as Z, Switch as Te, InputNumber as ze } from "antd";
import { useTranslation as S } from "react-i18next";
import { createStyles as G } from "antd-style";
import * as Pe from "@ant-design/icons";
import { UploadOutlined as _e, CheckOutlined as Me, TeamOutlined as De, MoreOutlined as Ee, PlusOutlined as Re, ClockCircleFilled as Oe, MailOutlined as Ve, EyeOutlined as ie, EyeInvisibleOutlined as Ne, LaptopOutlined as $e, EnvironmentOutlined as Be, GlobalOutlined as Ue, ClockCircleOutlined as qe, SearchOutlined as He, ReloadOutlined as Ke } from "@ant-design/icons";
import _ from "classnames";
import We, { useState as j, useEffect as V, useCallback as N, Suspense as Ge, forwardRef as Je, useImperativeHandle as Qe, useMemo as Y } from "react";
import { useRequest as z } from "ahooks";
import { a as C } from "./index.js";
import { b as $, A as Xe } from "./client.js";
import { isString as Ze } from "lodash-es";
const ee = () => /* @__PURE__ */ e.jsx("div", { style: {
  ...
  height: "100vh",
  width: "100%"
}, children: /* @__PURE__ */ e.jsx(fe, { size: "large" }) }), Ft = ({
  element: t,
  requiredPermission: r,
  requiredPermissions: n
}) => {
  const { t: s } = S(), { user: c, loading: l, error: i } = ne(), { hasPermission: d, hasAllPermissions: u } = K();
  ...
  ) : c ? r && !d(r) ? /* @__PURE__ */ e.jsx(J, { to: "/forbidden", replace: !0 }) : n && !u(n) ? /* @__PURE__ */ e.jsx(J, { to: "/forbidden", replace: !0 }) : t : (window.location.href = pe("/login?redirect=" + encodeURIComponent(window.location.href)), null);
}, Ye = G(({ token: t, css: r }) => ({
  container: r`
      ${r`
  ...
  const { i18n: n } = S(), { styles: s } = tt(), c = (i) => {
    n.changeLanguage(i);
  }, l = {
  ...
  avatarItem: t`
    ...
    padding: 5px;
  `
})), le = (t) => Ze(t) && t.match(/^[-_a-zA-Z0-9]+$/) ? $.endsWith("/") ? $ + `files/${t}` : $ + `/files/${t}` : t, rt = ({ src: t, fallback: r, ...n }) => /* @__PURE__ */ e.jsx(je, { src: le(t), icon: r, ...n }), at = ({ onChange: t, shape: r = "square" }) => {
  const [n, s] = j([]), { styles: c } = nt(), [l, i] = j(!1), [d, u] = j(!0), [h, m] = j(0), { run: o, loading: a } = z(() => C.base.listFiles({ current: h + 1, page_size: 40, file_type: "avatar", access: "public", search: "" }), {
    manual: !0,
    onSuccess: ({ data: f }) => {
                ...
                we,
                {
                  ...
                  renderItem: ({ id: f }) => /* @__PURE__ */ e.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ e.jsx(rt, { shape: r, src: f })
                    }
                  )
                }
              )
...
}, it = ({ value: t, onChange: r, shape: n, ...s }) => {
  const [c, l] = j(void 0), [i, d] = j(!1), [u, h] = j(void 0), m = async (o) => {
    d(!0), h(o.url ?? o.preview);
  };
  return V(() => {
    l(t ? {
      uid: t,
      ...
      de,
      {
        beforeCrop: async (o) => {
          if (o.type === "image/svg+xml") {
            const a = await C.base.uploadFile({ type: "avatar" }, o);
        ...
        children: /* @__PURE__ */ e.jsx(
          ye,
          {
            customRequest: async (o) => {
              var y, f;
              const a = await C.base.uploadFile({ type: "avatar", access: "public" }, o.file);
              a.length > 0 ? ((y = o.onSuccess) == null || y.call(o, a[0].id), r == null || r(a[0].id)) : (f = o.onError) == null || f.call(o, new Error("Upload file failed"));
            },
            ...
            fileList: c ? [c] : [],
            ...s,
            children: c ? void 0 : /* @__PURE__ */ e.jsx(at, { shape: n, onChange: r })
          }
        )
      }
    ),
  ...
  const { t: r } = S("common"), { user: n } = ne(), { currentOrgId: s, setCurrentOrgId: c } = me(), l = (n == null ? void 0 : n.organizations) || [], i = (m) => {
  ...
  const [s, c] = j(!1), [l, i] = j(!1), d = N((m) => {
    m.preventDefault(), c(!0);
  }, []), u = N(
    (m) => {
      if (!s) return;
      const o = window.innerWidth - m.clientX, a = Math.max(r, Math.min(n, o));
      t(a);
    },
    [s, r, n, t]
  ), h = N(() => {
  ...
  return h ? null : u ? /* @__PURE__ */ e.jsx(e.Fragment, { children: c }) : t ? l(t) ? /* @__PURE__ */ e.jsx(e.Fragment, { children: c }) : /* @__PURE__ */ e.jsx(e.Fragment, { children: s }) : r.length > 0 ? (n ? d(r) : i(r)) ? /* @__PURE__ */ e.jsx(e.Fragment, { children: c }) : /* @__PURE__ */ e.jsx(e.Fragment, { children: s }) : /* @__PURE__ */ e.jsx(e.Fragment, { children: c });
}, zt = ({
  fallback: t = null,
  children: r
}) => {
  ...
  const [r, n] = j(!1), { permission: s, icon: c, tooltip: l, onClick: i, confirm: d, label: u, ...h } = t, m = i ? async () => {
    n(!0);
    try {
      await i();
    } finally {
  ...
  if (l && (o = /* @__PURE__ */ e.jsx(Se, { title: l, children: o })), d) {
    const a = async () => {
  ...
  return s && (o = /* @__PURE__ */ e.jsx(ce, { permission: s, children: o })), o;
}, Pt = ({ actions: t, maxVisibleItems: r }) => {
  ...
  const s = n.slice(0, r - 1), l = n.slice(r - 1).map((i) => {
    const { key: d, label: u, icon: h, permission: m, onClick: o, confirm: a, disabled: y, tooltip: f } = i, I = {
      key: d,
      label: u,
      icon: h,
      disabled: y,
  ...
  return /* @__PURE__ */ e.jsxs(L.Compact, { children: [
    ...
    /* @__PURE__ */ e.jsx(b, { style: { width: "calc(100% - 80px)" }, value: s, onChange: (l) => c(l.target.value) }),
    /* @__PURE__ */ e.jsx(v, { type: "primary", icon: /* @__PURE__ */ e.jsx(Re, {}), onClick: () => {
      t(r, s);
    } })
  ] });
}, ct = ({ request: t, tableRef: r, ...n }, s) => {
  const [c, l] = j({
    current: 1,
    pageSize: 10
...
}, Et = ({ className: t, onSuccess: r, token: n }) => {
  const { t: s } = S("authorization"), { t: c } = S("common"), [l] = x.useForm(), { run: i, loading: d } = z(async (u) => C.authorization.changePassword(u, n ? { headers: { Authorization: `Bearer ${n}` } } : {}), {
    manual: !0,
    onSuccess: () => {
  ...
  return /* @__PURE__ */ e.jsxs(
    x,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ e.jsx(x.Item, { className: _("profile-password-item", "profile-password-item-submit"), children: /* @__PURE__ */ e.jsx(v, { type: "primary", htmlType: "submit", loading: d, children: c("save") }) })
      ]
    }
  );
}, Rt = ({ user: t, onSuccess: r }) => {
  const { t: n } = S("authorization"), { t: s } = S("common"), [c] = x.useForm(), [l, i] = j(!1);
  We.useEffect(() => {
    t && c.setFieldsValue({
      username: t.username,
      email: t.email,
...
}, Ot = ({ user: t, onSuccess: r }) => {
  const { t: n } = S("authorization"), { t: s } = S("common"), [c, l] = j(0), [i, d] = j(!1), [u, h] = j(!0), [m, o] = j(""), [a, y] = j("totp"), { run: f, data: g = { secret: "", qr_code: "", token: void 0 } } = z(
  ...
  const { t } = S("authorization"), { t: r } = S("common"), [n, s] = j(null), [c, l] = j(!1), { data: i = [], loading: d, run: u } = z(() => C.authorization.getUserSessions({}), {
    onError: (a) => {
...
}, { RangePicker: dt } = Ae, { Option: P } = T, ut = (t) => t || "N/A", mt = (t, r) => t === "success" ? /* @__PURE__ */ e.jsx(R, { color: "success", children: r("statuses.success") }) : /* @__PURE__ */ e.jsx(R, { color: "error", children: r("statuses.failed") }), Nt = ({
  userId: t,
  request: r = (s) => t ? C.authorization.getUserLogs({ id: t, ...s }) : C.authorization.getCurrentUserLogs(s),
  columnsFilter: n = (s) => s
}) => {
  const { t: s } = S("authorization"), { t: c } = S("common"), [l, i] = j({
    current: 1,
    pageSize: 10,
    total: 0
  }), [d, u] = j({}), [h] = x.useForm(), { loading: m, run: o, data: { data: a } = {} } = z(async (p = d, F = 1, k = 10) => r({
    ...p,
    current: F ?? 1,
    page_size: k ?? 10
  }), {
  ...
  const y = (p) => {
    ...
    h.resetFields(), u({}), i({ ...l, current: 1 }), o({}, 1, l.pageSize);
  }, I = [
    {
      ...
      x,
      {
        ...
        children: [
          /* @__PURE__ */ e.jsxs(X, { gutter: 24, children: [
            ...
            /* @__PURE__ */ e.jsx(M, { span: 6, children: /* @__PURE__ */ e.jsx(x.Item, { name: "dateRange", label: s("auditLog.dateRange"), children: /* @__PURE__ */ e.jsx(dt, { style: { width: "100%" } }) }) })
          ] }),
          /* @__PURE__ */ e.jsx(X, { children: /* @__PURE__ */ e.jsx(M, { span: 24, style: { textAlign: "right" }, children: /* @__PURE__ */ e.jsxs(L, { children: [
            /* @__PURE__ */ e.jsx(v, { onClick: g, children: c("reset") }),
            /* @__PURE__ */ e.jsx(v, { type: "primary", htmlType: "submit", icon: /* @__PURE__ */ e.jsx(He, {}), children: c("search") })
          ] }) }) })
        ]
      }
    ) }),
      ...
      /* @__PURE__ */ e.jsx(
        W,
        {
          ...
          pagination: {
            ...l,
            showSizeChanger: !0,
            showTotal: (p) => c("totalItems", { total: p })
          },
          loading: m,
          onChange: y,
...
}, { TextArea: se } = b, { Option: U } = T, $t = ({
  field: t,
  selectedType: r,
  dependentValues: n,
  formValues: s = {}
}) => {
  const { t: c } = S("system"), { t: l } = S("common"), i = Y(() => ge(t.visible_when, s), [t.visible_when, s]), { options: d, loading: u } = he(
    t.data_source,
    t.options,
    n
