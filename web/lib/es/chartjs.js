...
var Xs = (i, t, e) => t in i ? Ys(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var O = (i, t, e) => Xs(i, typeof t != "symbol" ? t + "" : t, e);
import rs, { forwardRef as as, useRef as Ge, useEffect as kt } from "react";
import { C as ls } from "./vendor.js";
/*!
 * Chart.js v4.4.8
...
const Gs = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 * t : +i;
function z(i, t, e) {
...
function Zs(i, t, e) {
  if (!cs(i))
    return;
  const s = t[i], n = e[i];
  C(s) && C(n) ? Ht(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = de(n));
}
const Qe = {
...
function Pt(i, t) {
  return (Qe[t] || (Qe[t] = tn(t)))(i);
}
function Be(i) {
  return i.charAt(0).toUpperCase() + i.slice(1);
}
const $t = (i) => typeof i < "u", lt = (i) => typeof i == "function", Ze = (i, t) => {
  if (i.size !== t.size)
    return !1;
  for (const e of i)
    if (!t.has(e))
...
const V = Math.PI, rt = 2 * V, ue = Number.POSITIVE_INFINITY, sn = V / 180, q = V / 2, ut = V / 4, Je = V * 2 / 3, hs = Math.log10, at = Math.sign;
function re(i, t, e) {
...
function ti(i) {
  ...
  i = re(i, t, i / 1e3) ? t : i;
  const e = Math.pow(10, Math.floor(hs(i))), s = i / e;
...
function fe(i) {
  return !on(i) && !isNaN(parseFloat(i)) && isFinite(i);
}
function rn(i, t) {
...
const Ie = (i, t, e, s) => He(i, e, s ? (n) => {
  const o = i[n][t];
  return o < e || o === e && i[n + 1][t] === e;
} : (n) => i[n][t] < e), fn = (i, t, e) => He(i, e, (s) => i[s][t] >= e);
function gn(i, t, e) {
  let s = 0, n = i.length;
  for (; s < n && i[s] < t; )
    s++;
...
const We = (i) => i === "start" ? "left" : i === "end" ? "right" : "center", H = (i, t, e) => i === "start" ? t : i === "end" ? e : (t + e) / 2, bn = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t, Gt = (i) => i === 0 || i === 1, si = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin((i - t) * rt / e)), ni = (i, t, e) => Math.pow(2, -10 * i) * Math.sin((i - t) * rt / e) + 1, Wt = {
  linear: (i) => i,
  easeInQuad: (i) => i * i,
  easeOutQuad: (i) => -i * (i - 2),
  ...
  easeInOutExpo: (i) => Gt(i) ? i : i < 0.5 ? 0.5 * Math.pow(2, 10 * (i * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
  easeInCirc: (i) => i >= 1 ? i : -(Math.sqrt(1 - i * i) - 1),
  easeOutCirc: (i) => Math.sqrt(1 - (i -= 1) * i),
  easeInOutCirc: (i) => (i /= 0.5) < 1 ? -0.5 * (Math.sqrt(1 - i * i) - 1) : 0.5 * (Math.sqrt(1 - (i -= 2) * i) + 1),
  easeInElastic: (i) => Gt(i) ? i : si(i, 0.075, 0.3),
  easeOutElastic: (i) => Gt(i) ? i : ni(i, 0.075, 0.3),
  easeInOutElastic(i) {
    return Gt(i) ? i : i < 0.5 ? 0.5 * si(i * 2, 0.1125, 0.45) : 0.5 + 0.5 * ni(i * 2 - 1, 0.1125, 0.45);
  },
  easeInBack(i) {
  ...
  easeInBounce: (i) => 1 - Wt.easeOutBounce(1 - i),
  easeOutBounce(i) {
    return i < 1 / 2.75 ? 7.5625 * i * i : i < 2 / 2.75 ? 7.5625 * (i -= 1.5 / 2.75) * i + 0.75 : i < 2.5 / 2.75 ? 7.5625 * (i -= 2.25 / 2.75) * i + 0.9375 : 7.5625 * (i -= 2.625 / 2.75) * i + 0.984375;
  },
  easeInOutBounce: (i) => i < 0.5 ? Wt.easeInBounce(i * 2) * 0.5 : Wt.easeOutBounce(i * 2 - 1) * 0.5 + 0.5
};
function ps(i) {
...
function oi(i) {
  return ps(i) ? i : new ls(i);
}
function ve(i) {
  return ps(i) ? i : new ls(i).saturate(0.5).darken(0.1).hexString();
}
const _n = [
  "x",
  "y",
...
const wn = {
  ...
  numeric(i, t, e) {
    ...
    if (e.length > 1) {
      ...
      (c < 1e-4 || c > 1e15) && (n = "scientific"), o = Mn(i, e);
    }
    const r = hs(Math.abs(o)), a = isNaN(r) ? 1 : Math.max(Math.min(-1 * Math.floor(r), 20), 0), l = {
      notation: n,
      minimumFractionDigits: a,
      maximumFractionDigits: a
    };
    return Object.assign(l, this.options.ticks.format), ms(i, s, l);
  }
};
function Mn(i, t) {
...
const xt = /* @__PURE__ */ Object.create(null), ze = /* @__PURE__ */ Object.create(null);
function Vt(i, t) {
  if (!t)
    return i;
  const e = t.split(".");
...
function ke(i, t, e) {
  return typeof t == "string" ? jt(Vt(i, t), e) : jt(Vt(i, ""), t);
}
class Pn {
  constructor(t, e) {
  ...
  route(t, e, s, n) {
    const o = Vt(this, t), r = Vt(this, s), a = "_" + e;
    Object.defineProperties(o, {
      ...
      [e]: {
        ...
        get() {
          ...
          return C(l) ? Object.assign({}, c, l) : A(l, c);
        },
        set(l) {
          this[a] = l;
        }
...
function _s(i, t, e, s, n) {
  ...
  if (!(isNaN(g) || g <= 0)) {
    switch (i.beginPath(), f) {
      default:
        n ? i.ellipse(e, s, n / 2, g, 0, 0, rt) : i.arc(e, s, g, 0, rt), i.closePath();
        break;
      case "triangle":
        h = n ? n / 2 : g, i.moveTo(e + Math.sin(m) * h, s - Math.cos(m) * g), m += Je, i.lineTo(e + Math.sin(m) * h, s - Math.cos(m) * g), m += Je, i.lineTo(e + Math.sin(m) * h, s - Math.cos(m) * g), i.closePath();
        break;
      case "rectRounded":
        c = g * 0.516, l = g - c, r = Math.cos(m + ut) * l, d = Math.cos(m + ut) * (n ? n / 2 - c : l), a = Math.sin(m + ut) * l, u = Math.sin(m + ut) * (n ? n / 2 - c : l), i.arc(e - d, s - a, c, m - V, m - q), i.arc(e + u, s - r, c, m - q, m), i.arc(e + d, s + a, c, m, m + q), i.arc(e - u, s + r, c, m + q, m + V), i.closePath();
        break;
      case "rect":
        if (!p) {
      ...
      case "cross":
        ...
        break;
      case "star":
        d = Math.cos(m) * (n ? n / 2 : g), r = Math.cos(m) * g, a = Math.sin(m) * g, u = Math.sin(m) * (n ? n / 2 : g), i.moveTo(e - d, s - a), i.lineTo(e + d, s + a), i.moveTo(e + u, s - r), i.lineTo(e - u, s + r), m += ut, d = Math.cos(m) * (n ? n / 2 : g), r = Math.cos(m) * g, a = Math.sin(m) * g, u = Math.sin(m) * (n ? n / 2 : g), i.moveTo(e - d, s - a), i.lineTo(e + d, s + a), i.moveTo(e + u, s - r), i.lineTo(e - u, s + r);
        break;
      case "line":
...
function Ut(i, t, e, s, n, o = {}) {
  const r = E(t) ? t : [
    t
  ], a = o.strokeWidth > 0 && o.strokeColor !== "";
  let l, c;
  for (i.save(), i.font = n.string, Cn(i, o), l = 0; l < r.length; ++l)
    c = r[l], o.backdrop && Tn(i, o.backdrop), a && (o.strokeColor && (i.strokeStyle = o.strokeColor), I(o.strokeWidth) || (i.lineWidth = o.strokeWidth), i.strokeText(c, e, s, o.maxWidth)), i.fillText(c, e, s, o.maxWidth), Dn(i, e, s, c, o), s += Number(n.lineHeight);
  i.restore();
}
function ge(i, t) {
  const { x: e, y: s, w: n, h: o, radius: r } = t;
  i.arc(e + r.topLeft, s + r.topLeft, r.topLeft, 1.5 * V, V, !0), i.lineTo(e, s + o - r.bottomLeft), i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, V, q, !0), i.lineTo(e + n - r.bottomRight, s + o), i.arc(e + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, q, 0, !0), i.lineTo(e + n, s + r.topRight), i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -q, !0), i.lineTo(e + r.topLeft, s);
}
const An = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/, Ln = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function In(i, t) {
  const e = ("" + i).match(An);
  if (!e || e[1] === "normal")
    return t * 1.2;
...
const zn = (i) => +i || 0;
function ys(i, t) {
  const e = {}, s = C(t), n = s ? Object.keys(t) : t, o = C(i) ? s ? (r) => A(i[r], i[t[r]]) : (r) => i[r] : () => i;
  for (const r of n)
    e[r] = zn(o(r));
  return e;
}
...
function W(i, t) {
  ...
  s && !("" + s).match(Ln) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
  const n = {
    family: A(i.family, t.family),
    lineHeight: In(A(i.lineHeight, t.lineHeight), e),
    size: e,
    style: s,
...
function Rn(i, t, e) {
  const { min: s, max: n } = i, o = Gs(t, (n - s) / 2), r = (a, l) => e && a === 0 ? 0 : a + l;
  return {
    min: r(s, -Math.abs(o)),
    max: r(n, o)
  };
...
function Ot(i, t, e, s) {
  const n = {
    ...
    _descriptors: ks(i, s),
    setContext: (o) => Ot(i, o, e, s),
    override: (o) => Ot(i.override(o), t, e, s)
  };
  return new Proxy(n, {
    /**
    * A trap for the delete operator.
...
const Fn = (i, t) => i ? i + Be(t) : t, $e = (i, t) => C(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function ws(i, t, e) {
...
function En(i, t, e) {
  ...
  let a = s[t];
  return lt(a) && r.isScriptable(t) && (a = Bn(t, a, i, e)), E(a) && a.length && (a = Hn(t, a, i, r.isIndexable)), $e(t, a) && (a = Ot(a, n, o && o[t], r)), a;
}
function Bn(i, t, e, s) {
  ...
  a.add(i);
  let l = t(o, r || s);
  return a.delete(i), $e(i, l) && (l = Ue(n._scopes, n, i, l)), l;
}
function Hn(i, t, e, s) {
...
const Wn = (i, t) => i === !0 ? t : typeof i == "string" ? Pt(t, i) : void 0;
function Vn(i, t, e, s, n) {
  for (const o of t) {
    const r = Wn(e, o);
    if (r) {
      i.add(r);
      const a = Ms(r._fallback, e, n);
...
function Ue(i, t, e, s) {
  const n = t._rootScopes, o = Ms(t._fallback, e, s), r = [
    ...i,
    ...n
  ], a = /* @__PURE__ */ new Set();
  a.add(s);
  let l = hi(a, r, e, o || e, s);
  return l === null || typeof o < "u" && o !== e && (l = hi(a, r, o, l, s), l === null) ? !1 : je(Array.from(a), [
    ""
  ], n, o, () => Nn(t, e, s));
}
...
function jn(i, t, e, s) {
  let n;
  for (const o of t)
    if (n = Ss(Fn(o, i), e), typeof n < "u")
      return $e(i, n) ? Ue(e, s, i, n) : n;
}
function Ss(i, t) {
  for (const e of t) {
    if (!e)
...
function di(i) {
  let t = i._keys;
  return t || (t = i._keys = $n(i._scopes)), t;
}
function $n(i) {
...
const _e = (i) => i.ownerDocument.defaultView.getComputedStyle(i, null);
function Un(i, t) {
  return _e(i).getPropertyValue(t);
}
const Kn = [
  "top",
  "right",
...
const Yn = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function Xn(i, t) {
...
function mt(i, t) {
  if ("native" in i)
    return i;
  const { canvas: e, currentDevicePixelRatio: s } = t, n = _e(e), o = n.boxSizing === "border-box", r = _t(n, "padding"), a = _t(n, "border", "width"), { x: l, y: c, box: h } = Xn(i, e), d = r.left + (h && a.left), u = r.top + (h && a.top);
...
function qn(i, t, e) {
  ...
  if (t === void 0 || e === void 0) {
    ...
    if (!o)
      ...
      const r = o.getBoundingClientRect(), a = _e(o), l = _t(a, "border", "width"), c = _t(a, "padding");
      t = r.width - c.width - l.width, e = r.height - c.height - l.height, s = pe(a.maxWidth, o, "clientWidth"), n = pe(a.maxHeight, o, "clientHeight");
    }
  }
  return {
    width: t,
...
function Gn(i, t, e, s) {
  const n = _e(i), o = _t(n, "margin"), r = pe(n.maxWidth, i, "clientWidth") || ue, a = pe(n.maxHeight, i, "clientHeight") || ue, l = qn(i, t, e);
  let { width: c, height: h } = l;
  if (n.boxSizing === "content-box") {
    const u = _t(n, "border", "width"), f = _t(n, "padding");
...
const Qn = function() {
  ...
  try {
    ...
    Ke() && (window.addEventListener("test", null, t), window.removeEventListener("test", null, t));
  } catch {
  }
  return i;
}();
function fi(i, t) {
  const e = Un(i, t), s = e && e.match(/^(\d+)(\.\d+)?px$/);
  return s ? +s[1] : void 0;
}
const Zn = function(i, t) {
  return {
    x(e) {
      return i + i + t - e;
    },
...
var it = /* @__PURE__ */ new to();
const gi = "transparent", eo = {
  boolean(i, t, e) {
    return e > 0.5 ? t : i;
  },
  color(i, t, e) {
    const s = oi(i || gi), n = s.valid && oi(t || gi);
...
class io {
  constructor(t, e, s, n) {
    ...
    this._active = !0, this._fn = t.fn || eo[t.type || typeof r], this._easing = Wt[t.easing] || Wt.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = s, this._from = r, this._to = n, this._promises = void 0;
  }
  active() {
    return this._active;
  }
...
class Cs {
  ...
  _animateOptions(t, e) {
    const s = e.options, n = no(t, s);
    if (!n)
      return [];
    const o = this._createAnimations(n, s);
    return s.$shared && so(t.options.$animations, s).then(() => {
      t.options = s;
    }, () => {
    }), o;
  }
...
function mi(i, t, e, s = {}) {
  ...
  for (r = 0, a = n.length; r < a; ++r) {
    ...
    c = i.values[l], Y(c) && (o || t === 0 || at(t) === at(c)) && (t += c);
  }
  return !h && !s.all ? 0 : t;
}
function ao(i, t) {
...
function _i(i, t) {
  const { chart: e, _cachedMeta: s } = i, n = e._stacks || (e._stacks = {}), { iScale: o, vScale: r, index: a } = s, l = o.axis, c = r.axis, h = lo(o, r, s), d = t.length;
  let u;
  for (let f = 0; f < d; ++f) {
    const p = t[f], { [l]: g, [c]: m } = p, b = p._stacks || (p._stacks = {});
    u = b[c] = ho(n, h, g), u[a] = m, u._top = bi(u, r, !0, s.type), u._bottom = bi(u, r, !1, s.type);
...
const Se = (i) => i === "reset" || i === "none", xi = (i, t) => t ? i : Object.assign({}, i), go = (i, t, e) => i && !t.hidden && t._stacked && {
  keys: Ds(e, !0),
  values: null
};
class Nt {
  ...
  linkScales() {
    const t = this.chart, e = this._cachedMeta, s = this.getDataset(), n = (d, u, f, p) => d === "x" ? u : d === "r" ? p : f, o = e.xAxisID = A(s.xAxisID, Me(t, "x")), r = e.yAxisID = A(s.yAxisID, Me(t, "y")), a = e.rAxisID = A(s.rAxisID, Me(t, "r")), l = e.indexAxis, c = e.iAxisID = n(l, o, r, a), h = e.vAxisID = n(l, r, o, a);
  ...
  _destroy() {
    const t = this._cachedMeta;
    this._data && ii(this._data, this), t._stacked && Lt(t);
  }
  _dataCheck() {
    ...
    if (C(e)) {
      ...
      e && Object.isExtensible(e) && pn(e, this), this._syncList = [], this._data = e;
    }
  }
  addElements() {
    const t = this._cachedMeta;
  ...
  buildOrUpdateElements(t) {
    ...
    this._dataCheck();
    const o = e._stacked;
    e._stacked = we(e.vScale, e), e.stack !== s.stack && (n = !0, Lt(e), e.stack = s.stack), this._resyncElements(t), (n || o !== e._stacked) && (_i(this, e._parsed), e._stacked = we(e.vScale, e));
  }
  configure() {
  ...
  updateRangeFromParsed(t, e, s, n) {
    ...
    n && a && (n.values = a, r = mi(n, o, this._cachedMeta.index)), t.min = Math.min(t.min, r), t.max = Math.max(t.max, r);
  }
  getMinMax(t, e) {
    const s = this._cachedMeta, n = s._parsed, o = s._sorted && t === s.iScale, r = n.length, a = this._getOtherScale(t), l = go(e, s, this.chart), c = {
  ...
  _update(t) {
    const e = this._cachedMeta;
    this.update(t || "default"), e._clip = ro(A(this.options.clip, oo(e.xScale, e.yScale, this.getMaxOverflow())));
  }
  update(t) {
  }
  draw() {
  ...
  getContext(t, e, s) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      o = r.$context || (r.$context = fo(this.getContext(), t, r)), o.parsed = this.getParsed(t), o.raw = n.data[t], o.index = o.dataIndex = t;
    } else
      o = this.$context || (this.$context = uo(this.chart.getContext(), this.index)), o.dataset = n, o.index = o.datasetIndex = this.index;
  ...
  _resolveElementOptions(t, e = "default", s) {
    const n = e === "active", o = this._cachedDataOpts, r = t + "-" + e, a = o[r], l = this.enableOptionSharing && $t(s);
    if (a)
      return xi(a, l);
    ...
    return g.$shared && (g.$shared = l, o[r] = Object.freeze(xi(g, l))), g;
  }
  _resolveAnimations(t, e, s) {
    ...
    const c = new Cs(n, l && l.animations);
  ...
  updateElement(t, e, s, n) {
    Se(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s);
  }
  updateSharedOptions(t, e, s) {
    t && !Se(e) && this._resolveAnimations(void 0, e).update(t, s);
  }
  _setStyle(t, e, s, n) {
    t.active = n;
...
O(Nt, "defaults", {}), O(Nt, "datasetElementType", null), O(Nt, "dataElementType", null);
function po(i, t) {
  if (!i._cache.$bar) {
...
function mo(i) {
  const t = i.iScale, e = po(t, i.type);
  let s = t._length, n, o, r, a;
  const l = () => {
    r === 32767 || r === -32768 || ($t(a) && (s = Math.min(s, Math.abs(r - a) || s)), a = r);
  };
  for (n = 0, o = e.length; n < o; ++n)
...
function Ts(i, t, e, s) {
  return E(i) ? xo(i, t, e, s) : t[e.axis] = e.parse(i, s), t;
}
function yi(i, t, e, s) {
  const n = i.iScale, o = i.vScale, r = n.getLabels(), a = n === o, l = [];
  let c, h, d, u;
  for (c = e, h = e + s; c < h; ++c)
    u = t[c], d = {}, d[n.axis] = a || n.parse(r[c], c), l.push(Ts(u, d, o, c));
  return l;
}
function Pe(i) {
...
function ko(i, t, e, s) {
  ...
  const { start: r, end: a, reverse: l, top: c, bottom: h } = vo(i);
  n === "middle" && e && (i.enableBorderRadius = !0, (e._top || 0) === s ? n = c : (e._bottom || 0) === s ? n = h : (o[vi(h, r, a, l)] = !0, n = c)), o[vi(n, r, a, l)] = !0, i.borderSkipped = o;
}
function vi(i, t, e, s) {
  return s ? (i = wo(i, t, e), i = ki(i, e, t)) : i = ki(i, t, e), i;
}
function wo(i, t, e) {
...
function Mo(i, { inflateAmount: t }, e) {
...
class ae extends Nt {
  ...
  parseObjectData(t, e, s, n) {
    ...
    let u, f, p, g;
    for (u = s, f = s + n; u < f; ++u)
      g = e[u], p = {}, p[o.axis] = o.parse(Pt(g, c), u), d.push(Ts(Pt(g, h), p, r, u));
    return d;
  }
  updateRangeFromParsed(t, e, s, n) {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta, { iScale: s, vScale: n } = e, o = this.getParsed(t), r = o._custom, a = Pe(r) ? "[" + r.start + ", " + r.end + "]" : "" + n.getLabelForValue(o[n.axis]);
    return {
  ...
  updateElements(t, e, s, n) {
    ...
    for (let f = e; f < e + s; f++) {
      const p = this.getParsed(f), g = o || I(p[a.axis]) ? {
        ...
        horizontal: c,
        base: g.base,
        enableBorderRadius: !b || Pe(p._custom) || r === b._top || r === b._bottom,
        x: c ? g.head : m.center,
        y: c ? m.center : g.head,
      ...
      ko(_, y, b, r), Mo(_, y, h.ratio), this.updateElement(t[f], f, _, n);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    const { _cachedMeta: { vScale: e, _stacked: s, index: n }, options: { base: o, minBarLength: r } } = this, a = o || 0, l = this.getParsed(t), c = l._custom, h = Pe(c);
    ...
    if (b === e.getPixelForValue(a)) {
      const _ = at(g) * e.getLineWidthForValue(a) / 2;
      b += _, g -= _;
    }
    return {
      size: g,
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    let a, l;
    if (e.grouped) {
      const c = o ? this._getStackCount(t) : e.stackCount, h = n.barThickness === "flex" ? _o(t, e, n, c) : bo(t, e, n, c), d = this._getStackIndex(this.index, this._cachedMeta.stack, o ? t : void 0);
...
function Po(i, t, e, s) {
  ...
  if (a && t === a.axis && t !== "r" && r && o.length) {
    const c = a._reversePixels ? fn : Ie;
    if (s) {
      if (n._sharedOptions) {
...
function xe(i, t, e, s, n) {
  ...
  for (let a = 0, l = o.length; a < l; ++a) {
    const { index: c, data: h } = o[a], { lo: d, hi: u } = Po(o[a], t, r, n);
    for (let f = d; f <= u; ++f) {
      const p = h[f];
      p.skip || s(p, c, f);
    }
...
function Oe(i, t, e, s, n) {
  const o = [];
  return !n && !i.isPointInArea(t) || xe(i, e, t, function(a, l, c) {
    !n && !xs(a, i.chartArea, 0) || a.inRange(t.x, t.y, s) && o.push({
      element: a,
      datasetIndex: l,
      index: c
    });
...
function Ce(i, t, e, s, n, o) {
  return !o && !i.isPointInArea(t) ? [] : e === "r" && !s ? Co(i, t, e, n) : Do(i, t, e, s, n, o);
}
...
var To = {
  modes: {
    index(i, t, e, s) {
      const n = mt(t, i), o = e.axis || "x", r = e.includeInvisible || !1, a = e.intersect ? Oe(i, n, o, s, r) : Ce(i, n, o, !1, s, r), l = [];
    ...
    dataset(i, t, e, s) {
      ...
      let a = e.intersect ? Oe(i, n, o, s, r) : Ce(i, n, o, !1, s, r);
      if (a.length > 0) {
    ...
    nearest(i, t, e, s) {
      const n = mt(t, i), o = e.axis || "xy", r = e.includeInvisible || !1;
      return Ce(i, n, o, e.intersect, s, r);
    },
    x(i, t, e, s) {
      const n = mt(t, i);
...
function Io(i, t) {
  const e = Lo(i), { vBoxMaxWidth: s, hBoxMaxHeight: n } = t;
  let o, r, a;
...
function zo(i) {
  const t = Ao(i), e = zt(t.filter((c) => c.box.fullSize), !0), s = zt(It(t, "left"), !0), n = zt(It(t, "right")), o = zt(It(t, "top"), !0), r = zt(It(t, "bottom")), a = Mi(t, "x"), l = Mi(t, "y");
  return {
    fullSize: e,
...
function Ro(i, t, e, s) {
  ...
  o.getPadding && Ls(r, o.getPadding());
  const a = Math.max(0, t.outerWidth - Si(r, i, "left", "right")), l = Math.max(0, t.outerHeight - Si(r, i, "top", "bottom")), c = a !== i.w, h = l !== i.h;
...
function Et(i, t, e, s) {
  ...
  for (o = 0, r = i.length, c = 0; o < r; ++o) {
    a = i[o], l = a.box, l.update(a.width || t.w, a.height || t.h, Eo(a.horizontal, t));
    const { same: d, other: u } = Ro(t, e, a, s);
    c |= d && n.length, h = h || u, l.fullSize || n.push(a);
  }
  return c && Et(n, t, e, s) || h;
}
...
function Pi(i, t, e, s) {
  ...
  for (const a of i) {
    ...
    if (a.horizontal) {
      ...
      $t(c.start) && (r = c.start), l.fullSize ? Jt(l, n.left, r, e.outerWidth - n.right - n.left, u) : Jt(l, t.left + c.placed, r, d, u), c.start = r, c.placed += d, r = l.bottom;
    } else {
      const d = t.h * h, u = c.size || l.width;
      $t(c.start) && (o = c.start), l.fullSize ? Jt(l, o, n.top, u, e.outerHeight - n.bottom - n.top) : Jt(l, o, t.top + c.placed, u, d), c.start = o, c.placed += d, o = l.right;
    }
  }
  t.x = o, t.y = r;
}
var K = {
  ...
  update(i, t, e, s) {
    if (!i)
      return;
    const n = X(i.options.layout.padding), o = Math.max(t - n.width, 0), r = Math.max(e - n.height, 0), a = zo(i.boxes), l = a.vertical, c = a.horizontal;
    T(i.boxes, (g) => {
    ...
    Et(a.fullSize, f, d, p), Et(l, f, d, p), Et(c, f, d, p) && Et(l, f, d, p), Fo(f), Pi(a.leftAndTop, f, d, p), f.x += f.w, f.y += f.h, Pi(a.rightAndBottom, f, d, p), i.chartArea = {
      left: f.left,
      top: f.top,
      right: f.left + f.w,
      bottom: f.top + f.h,
...
function Wo(i, t) {
  ...
  }, e.display = e.display || "block", e.boxSizing = e.boxSizing || "border-box", Oi(n)) {
    const o = fi(i, "width");
    o !== void 0 && (i.width = o);
  }
  if (Oi(s))
...
function jo(i, t) {
  const e = Ho[i.type] || i.type, { x: s, y: n } = mt(i, t);
  return {
    type: e,
    chart: t,
    native: i,
...
function $o(i, t, e) {
  const s = i.canvas, n = new MutationObserver((o) => {
    let r = !1;
    for (const a of o)
      r = r || me(a.addedNodes, s), r = r && !me(a.removedNodes, s);
    r && e();
  });
...
function Uo(i, t, e) {
  const s = i.canvas, n = new MutationObserver((o) => {
    let r = !1;
    for (const a of o)
      r = r || me(a.removedNodes, s), r = r && !me(a.addedNodes, s);
    r && e();
  });
  return n.observe(document, {
    childList: !0,
...
function Rs() {
  ...
  i !== Ci && (Ci = i, Kt.forEach((t, e) => {
    e.currentDevicePixelRatio !== i && t();
  }));
}
function Ko(i, t) {
  Kt.size || window.addEventListener("resize", Rs), Kt.set(i, t);
}
function Yo(i) {
  Kt.delete(i), Kt.size || window.removeEventListener("resize", Rs);
}
function Xo(i, t, e) {
  const s = i.canvas, n = s && Ye(s);
  if (!n)
    return;
  const o = gs((a, l) => {
  ...
  return r.observe(n), Ko(i, o), r;
}
function De(i, t, e) {
  e && e.disconnect(), t === "resize" && Yo(i);
}
function qo(i, t, e) {
  const s = i.canvas, n = gs((o) => {
    i.ctx !== null && e(jo(o, i));
  }, i);
  return Vo(s, t, n), n;
}
class Go extends Is {
  acquireContext(t, e) {
    ...
    return s && s.canvas === t ? (Wo(t, e), s) : null;
  }
  releaseContext(t) {
    const e = t.canvas;
    if (!e[le])
      return !1;
    const s = e[le].initial;
    [
      "height",
      "width"
    ].forEach((o) => {
...
function Qo(i) {
  return !Ke() || typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas ? Bo : Go;
}
class ct {
  constructor() {
    O(this, "x");
...
function Zo(i, t) {
  const e = i.options.ticks, s = Jo(i), n = Math.min(e.maxTicksLimit || s, s), o = e.major.enabled ? er(t) : [], r = o.length, a = o[0], l = o[r - 1], c = [];
  if (r > n)
    return ir(t, c, o, r / n), c;
  const h = tr(o, t, n);
  if (r > 0) {
    let d, u;
    const f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
    for (te(t, c, h, I(f) ? 0 : a - f, a), d = 0, u = r - 1; d < u; d++)
      te(t, c, h, o[d], o[d + 1]);
    return te(t, c, h, l, I(f) ? t.length : l + f), c;
  }
  return te(t, c, h), c;
}
function Jo(i) {
...
const nr = (i) => i === "left" ? "right" : i === "right" ? "left" : i, Di = (i, t, e) => t === "top" || t === "left" ? i[t] + e : i[t] - e, Ti = (i, t) => Math.min(t || i, i);
function Ai(i, t) {
...
function Li(i, t) {
  if (!i.display)
    return 0;
  const e = W(i.font, t), s = X(i.padding);
...
function hr(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    ...
    } else e === "center" ? p = (c.bottom + c.top) / 2 + g - t : p = Di(i, e, t);
    u = a - o;
  } else {
    if (C(e)) {
      const b = Object.keys(e)[0], _ = e[b];
      f = h[b].getPixelForValue(_) - m + t;
    } else e === "center" ? f = (c.left + c.right) / 2 - m + t : f = Di(i, e, t);
    p = H(s, r, n), d = e === "left" ? -q : q;
  }
  return {
    titleX: f,
    titleY: p,
...
class Dt extends ct {
  ...
  update(t, e, s) {
    ...
    this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = s = Object.assign({
      ...
      top: 0,
      bottom: 0
    }, s), this.ticks = null, this._labelSizes = null, this._gridLineItems = null, this._labelItems = null, this.beforeSetDimensions(), this.setDimensions(), this.afterSetDimensions(), this._maxLength = this.isHorizontal() ? this.width + s.left + s.right : this.height + s.top + s.bottom, this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = Rn(this, o, n), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
    const l = a < this.ticks.length;
    this._convertTicksToLabels(l ? Ai(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), r.display && (r.autoSkip || r.source === "auto") && (this.ticks = Zo(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), l && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate();
  }
  configure() {
  ...
  calculateLabelRotation() {
    const t = this.options, e = t.ticks, s = Ti(this.ticks.length, t.ticks.maxTicksLimit), n = e.minRotation || 0, o = e.maxRotation;
    let r = n, a, l, c;
    if (!this._isVisible() || !e.display || n >= o || s <= 1 || !this.isHorizontal()) {
      this.labelRotation = n;
      return;
    }
    const h = this._getLabelSizes(), d = h.widest.width, u = h.highest.height, f = G(this.chart.width - d, 0, this.maxWidth);
    a = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > a && (a = f / (s - (t.offset ? 0.5 : 1)), l = this.maxHeight - Rt(t.grid) - e.padding - Li(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = ln(Math.min(Math.asin(G((h.highest.height + 6) / a, -1, 1)), Math.asin(G(l / c, -1, 1)) - Math.asin(G(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r;
  }
  ...
  fit() {
    ...
    if (r) {
      const l = Li(n, e.options.font);
      if (a ? (t.width = this.maxWidth, t.height = Rt(o) + l) : (t.height = this.maxHeight, t.width = Rt(o) + l), s.display && this.ticks.length) {
        const { first: c, last: h, widest: d, highest: u } = this._getLabelSizes(), f = s.padding * 2, p = bt(this.labelRotation), g = Math.cos(p), m = Math.sin(p);
        if (a) {
  ...
  _getLabelSizes() {
    ...
    if (!t) {
      ...
      let s = this.ticks;
      e < s.length && (s = Ai(s, e)), this._labelSizes = t = this._computeLabelSizes(s, s.length, this.options.ticks.maxTicksLimit);
    }
    return t;
  }
  _computeLabelSizes(t, e, s) {
    const { ctx: n, _longestTextCache: o } = this, r = [], a = [], l = Math.floor(e / Ti(e, s));
    let c = 0, h = 0, d, u, f, p, g, m, b, _, y, v, x;
    for (d = 0; d < e; d += l) {
      if (p = t[d].label, g = this._resolveTickFontOptions(d), n.font = m = g.string, b = o[m] = o[m] || {
        data: {},
        gc: []
      }, _ = g.lineHeight, y = v = 0, !I(p) && !E(p))
        y = ai(n, b.data, b.gc, y, p), v = _;
      else if (E(p))
        for (u = 0, f = p.length; u < f; ++u)
          x = p[u], !I(x) && !E(x) && (y = ai(n, b.data, b.gc, y, x), v += _);
      r.push(y), a.push(v), c = Math.max(y, c), h = Math.max(v, h);
    }
    rr(o, e);
    const k = r.indexOf(c), M = a.indexOf(h), w = (S) => ({
      width: r[S] || 0,
      height: a[S] || 0
    });
    return {
  ...
  getPixelForDecimal(t) {
    ...
    return un(this._alignToPixels ? gt(this.chart, e, 0) : e);
  }
  ...
  getContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      const s = e[t];
      return s.$context || (s.$context = lr(this.getContext(), t, s));
    }
    return this.$context || (this.$context = ar(this.chart.getContext(), this));
  }
  _tickSize() {
    const t = this.options.ticks, e = bt(this.labelRotation), s = Math.abs(Math.cos(e)), n = Math.abs(Math.sin(e)), o = this._getLabelSizes(), r = t.autoSkipPadding || 0, a = o ? o.widest.width + r : 0, l = o ? o.highest.height + r : 0;
  ...
  _computeGridLineItems(t) {
    const e = this.axis, s = this.chart, n = this.options, { grid: o, position: r, border: a } = n, l = o.offset, c = this.isHorizontal(), d = this.ticks.length + (l ? 1 : 0), u = Rt(o), f = [], p = a.setContext(this.getContext()), g = p.display ? p.width : 0, m = g / 2, b = function(B) {
      return gt(s, B, g);
    };
    let _, y, v, x, k, M, w, S, L, P, D, N;
    if (r === "top")
      _ = b(this.bottom), M = this.bottom - u, S = _ - m, P = b(t.top) + m, N = t.bottom;
    else if (r === "bottom")
      _ = b(this.top), P = t.top, N = b(t.bottom) - m, M = _ + m, S = this.top + u;
    else if (r === "left")
      _ = b(this.right), k = this.right - u, w = _ - m, L = b(t.left) + m, D = t.right;
    else if (r === "right")
      _ = b(this.left), L = t.left, D = b(t.right) - m, k = _ + m, w = this.left + u;
    else if (e === "x") {
      if (r === "center")
        _ = b((t.top + t.bottom) / 2 + 0.5);
      else if (C(r)) {
        const B = Object.keys(r)[0], U = r[B];
        _ = b(this.chart.scales[B].getPixelForValue(U));
      }
      P = t.top, N = t.bottom, M = _ + m, S = M + u;
    } else if (e === "y") {
      if (r === "center")
      ...
      k = _ - m, w = k - u, L = t.left, D = t.right;
    }
    const Q = A(n.ticks.maxTicksLimit, d), R = Math.max(1, Math.ceil(d / Q));
    for (y = 0; y < d; y += R) {
      const B = this.getContext(y), U = o.setContext(B), Yt = a.setContext(B), Xt = U.lineWidth, yt = U.color, qt = Yt.dash || [], vt = Yt.dashOffset, Tt = U.tickWidth, ht = U.tickColor, At = U.tickBorderDash || [], dt = U.tickBorderDashOffset;
      v = or(this, y, l), v !== void 0 && (x = gt(s, v, Xt), c ? k = w = L = D = x : M = S = P = N = x, f.push({
        tx1: k,
        ty1: M,
        tx2: w,
        ty2: S,
  ...
  _computeLabelItems(t) {
    const e = this.axis, s = this.options, { position: n, ticks: o } = s, r = this.isHorizontal(), a = this.ticks, { align: l, crossAlign: c, padding: h, mirror: d } = o, u = Rt(s.grid), f = u + h, p = d ? -h : f, g = -bt(this.labelRotation), m = [];
    let b, _, y, v, x, k, M, w, S, L, P, D, N = "middle";
    if (n === "top")
    ...
    for (b = 0, _ = a.length; b < _; ++b) {
      ...
      w = this.getPixelForTick(b) + o.labelOffset, S = this._resolveTickFontOptions(b), L = S.lineHeight, P = E(v) ? v.length : 1;
      const B = P / 2, U = R.color, Yt = R.textStrokeColor, Xt = R.textStrokeWidth;
      let yt = M;
      r ? (x = w, M === "inner" && (b === _ - 1 ? yt = this.options.reverse ? "left" : "right" : b === 0 ? yt = this.options.reverse ? "right" : "left" : yt = "center"), n === "top" ? c === "near" || g !== 0 ? D = -P * L + L / 2 : c === "center" ? D = -Q.highest.height / 2 - B * L + L : D = -Q.highest.height + L / 2 : c === "near" || g !== 0 ? D = L / 2 : c === "center" ? D = Q.highest.height / 2 - B * L : D = Q.highest.height - P * L, d && (D *= -1), g !== 0 && !R.showLabelBackdrop && (x += L / 2 * Math.sin(g))) : (k = w, D = (1 - P) * L / 2);
      let qt;
      if (R.showLabelBackdrop) {
        const vt = X(R.backdropPadding), Tt = Q.heights[b], ht = Q.widths[b];
        let At = D - vt.top, dt = 0 - vt.left;
        switch (N) {
          case "middle":
            At -= Tt / 2;
            break;
  ...
  drawTitle() {
    ...
    if (!s.display)
      return;
    const o = W(s.font), r = X(s.padding), a = s.align;
    let l = o.lineHeight / 2;
    e === "bottom" || e === "center" || C(e) ? (l += r.bottom, E(s.text) && (l += o.lineHeight * (s.text.length - 1))) : l += r.top;
    const { titleX: c, titleY: h, maxWidth: d, rotation: u } = hr(this, l, e, a);
    Ut(t, s.text, 0, 0, o, {
      color: s.color,
      maxWidth: d,
      rotation: u,
...
class ee {
  ...
  register(t) {
    ...
    return o in n || (n[o] = t, dr(t, r, s), this.override && F.override(t.id, t.overrides)), r;
  }
  get(t) {
    return this.items[t];
  }
  unregister(t) {
    ...
    s in e && delete e[s], n && s in F[n] && (delete F[n][s], this.override && delete xt[s]);
  }
}
function dr(i, t, e) {
  ...
  F.set(t, s), i.defaultRoutes && ur(t, i.defaultRoutes), i.descriptors && F.describe(t, i.descriptors);
}
function ur(i, t) {
...
class gr {
  constructor() {
    this.controllers = new ee(Nt, "datasets", !0), this.elements = new ee(ct, "elements"), this.plugins = new ee(Object, "plugins"), this.scales = new ee(Dt, "scales"), this._typedRegistries = [
      this.controllers,
      this.scales,
      this.elements
    ];
...
class pr {
  ...
  _createDescriptors(t, e) {
    const s = t && t.config, n = A(s.options && s.options.plugins, {}), o = mr(s);
...
function xr(i, { plugin: t, local: e }, s, n) {
...
function Fe(i, ...t) {
  if (Ii(i))
    return i;
  for (const e of t) {
    const s = e.axis || kr(e.position) || i.length > 1 && Ii(i[0].toLowerCase());
    if (s)
      return s;
  }
...
function Mr(i, t) {
  const e = xt[i.type] || {
    scales: {}
  }, s = t.scales || {}, n = Re(i.type, t), o = /* @__PURE__ */ Object.create(null);
  return Object.keys(s).forEach((r) => {
    ...
    const l = Fe(r, a, wr(r, i), F.scales[a.type]), c = vr(l, n), h = e.scales || {};
    o[r] = Ht(/* @__PURE__ */ Object.create(null), [
      {
        axis: l
      },
      a,
    ...
    const a = r.type || i.type, l = r.indexAxis || Re(a, t), h = (xt[a] || {}).scales || {};
    Object.keys(h).forEach((d) => {
      const u = yr(d, l), f = r[u + "AxisID"] || u;
      o[f] = o[f] || /* @__PURE__ */ Object.create(null), Ht(o[f], [
        {
          axis: u
        },
        s[f],
...
function Fs(i) {
  ...
  t.plugins = A(t.plugins, {}), t.scales = Mr(i, t);
}
function Es(i) {
  return i = i || {}, i.datasets = i.datasets || [], i.labels = i.labels || [], i;
}
function Sr(i) {
  return i = i || {}, i.data = Es(i.data), Fs(i), i;
}
const Ri = /* @__PURE__ */ new Map(), Bs = /* @__PURE__ */ new Set();
function ie(i, t) {
  let e = Ri.get(i);
  return e || (e = t(), Ri.set(i, e), Bs.add(e)), e;
}
const Ft = (i, t, e) => {
  const s = Pt(t, e);
  s !== void 0 && i.add(s);
...
class Pr {
  constructor(t) {
    this._config = Sr(t), this._scopeCache = /* @__PURE__ */ new Map(), this._resolverCache = /* @__PURE__ */ new Map();
  }
  get platform() {
  ...
  getOptionScopes(t, e, s) {
    ...
    e.forEach((h) => {
      t && (l.add(t), h.forEach((d) => Ft(l, t, d))), h.forEach((d) => Ft(l, n, d)), h.forEach((d) => Ft(l, xt[o] || {}, d)), h.forEach((d) => Ft(l, F, d)), h.forEach((d) => Ft(l, ze, d));
    });
    const c = Array.from(l);
    return c.length === 0 && c.push(/* @__PURE__ */ Object.create(null)), Bs.has(e) && r.set(e, c), c;
  }
  chartOptionScopes() {
  ...
  resolveNamedOptions(t, e, s, n = [
    ...
    const o = {
      $shared: !0
    }, { resolver: r, subPrefixes: a } = Fi(this._resolverCache, t, n);
    let l = r;
    if (Cr(r, e)) {
  ...
  createResolver(t, e, s = [
    ...
    const { resolver: o } = Fi(this._resolverCache, t, s);
    return C(e) ? Ot(o, e, void 0, n) : o;
  }
}
function Fi(i, t, e) {
  let s = i.get(t);
...
const Or = (i) => C(i) && Object.getOwnPropertyNames(i).some((t) => lt(i[t]));
function Cr(i, t) {
  const { isScriptable: e, isIndexable: s } = ks(i);
  for (const n of t) {
    const o = e(n), r = s(n), a = (r || o) && i[n];
    if (o && (lt(a) || Or(a)) || r && E(a))
      return !0;
  }
  return !1;
}
...
function Hs(i) {
  return Ke() && typeof i == "string" ? i = document.getElementById(i) : i && i.length && (i = i[0]), i && i.canvas && (i = i.canvas), i;
}
const ce = {}, Wi = (i) => {
  const t = Hs(i);
...
let qe = (nt = class {
  ...
  constructor(t, e) {
    const s = this.config = new Pr(e), n = Hs(t), o = Wi(n);
    if (o)
      throw new Error("Canvas is already in use. Chart with ID '" + o.id + "' must be destroyed before the canvas with ID '" + o.canvas.id + "' can be reused.");
    const r = s.createResolver(s.chartOptionScopes(), this.getContext());
    this.platform = new (s.platform || Qo(n))(), this.platform.updateConfig(s);
    const a = this.platform.acquireContext(n, r.aspectRatio), l = a && a.canvas, c = l && l.height, h = l && l.width;
    if (this.id = qs(), this.ctx = a, this.canvas = l, this.width = h, this.height = c, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new pr(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = mn((d) => this.update(d), r.resizeDelay || 0), this._dataChanges = [], ce[this.id] = this, !a || !l) {
      console.error("Failed to create chart: can't acquire context from the given item");
      return;
    }
    it.listen(this, "complete", Hi), it.listen(this, "progress", Ar), this._initialize(), this.attached && this.update();
  }
  get aspectRatio() {
  ...
  clear() {
    return li(this.canvas, this.ctx), this;
  }
  stop() {
  ...
  _resize(t, e) {
    ...
    this.width = r.width, this.height = r.height, this._aspectRatio = this.aspectRatio, ui(this, a, !0) && (this.notifyPlugins("resize", {
      size: r
    }), z(s.onResize, [
      this,
      r
  ...
  buildOrUpdateScales() {
    ...
    e && (o = o.concat(Object.keys(e).map((r) => {
      const a = e[r], l = Fe(r, a), c = l === "r", h = l === "x";
      return {
        options: a,
      ...
      const a = r.options, l = a.id, c = Fe(l, a), h = A(a.type, r.dtype);
      (a.position === void 0 || Ei(a.position, c) !== Ei(r.dposition)) && (a.position = r.dposition), n[l] = !0;
      let d = null;
      if (l in s && s[l].type === h)
        d = s[l];
      else {
        const u = tt.getScale(h);
        d = new u({
          id: l,
          type: h,
          ctx: this.ctx,
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
      ...
      if (r.type && r.type !== a && (this._destroyDatasetMeta(s), r = this.getDatasetMeta(s)), r.type = a, r.indexAxis = o.indexAxis || Re(a, this.options), r.order = o.order || 0, r.index = s, r.label = "" + o.label, r.visible = this.isDatasetVisible(s), r.controller)
        r.controller.updateIndex(s), r.controller.linkScales();
      else {
        const l = tt.getController(a), { datasetElementType: c, dataElementType: h } = F.datasets[a];
        Object.assign(l, {
  ...
  _checkEventBindings() {
    ...
    (!Ze(e, s) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents());
  }
  ...
  render() {
    this.notifyPlugins("beforeRender", {
      cancelable: !0
    }) !== !1 && (it.has(this) ? this.attached && !it.running(this) && it.start(this) : (this.draw(), Hi({
      chart: this
    })));
  }
  draw() {
  ...
  _drawDataset(t) {
    const e = this.ctx, s = t._clip, n = !s.disabled, o = zr(t, this.chartArea), r = {
      meta: t,
      index: t.index,
      cancelable: !0
    };
    ...
    }), t.controller.draw(), n && Ne(e), r.cancelable = !1, this.notifyPlugins("afterDatasetDraw", r));
  }
  isPointInArea(t) {
  ...
  _updateVisibility(t, e, s) {
    ...
    $t(e) ? (o.data[e].hidden = !s, this.update()) : (this.setDatasetVisibility(t, s), r.update(o, {
      visible: s
  ...
  destroy() {
    ...
    this._stop(), this.config.clearCache(), t && (this.unbindEvents(), li(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete ce[this.id], this.notifyPlugins("afterDestroy");
  }
  toBase64Image(...t) {
  ...
  _handleEvent(t, e, s) {
    const { _active: n = [], options: o } = this, r = e, a = this._getActiveElements(t, n, s, r), l = en(t), c = Ir(t, this._lastEvent, s, l);
...
}, O(nt, "defaults", F), O(nt, "instances", ce), O(nt, "overrides", xt), O(nt, "registry", tt), O(nt, "version", Dr), O(nt, "getChart", Wi), nt);
function Vi() {
  return T(qe.instances, (i) => i._plugins.invalidate());
}
function Ws(i, t) {
...
function Rr(i, t, e) {
  const s = i.options.borderWidth, n = i.borderSkipped, o = vs(s);
  return {
...
function Fr(i, t, e) {
  const { enableBorderRadius: s } = i.getProps([
    "enableBorderRadius"
  ]), n = i.options.borderRadius, o = Mt(n), r = Math.min(t, e), a = i.borderSkipped, l = s || C(n);
  return {
...
function Er(i) {
  const t = Ws(i), e = t.right - t.left, s = t.bottom - t.top, n = Rr(i, e / 2, s / 2), o = Fr(i, e / 2, s / 2);
  return {
    outer: {
      x: t.left,
      y: t.top,
...
function Te(i, t, e, s) {
  const n = t === null, o = e === null, a = i && !(n && o) && Ws(i, s);
  return a && (n || wt(t, a.left, a.right)) && (o || wt(e, a.top, a.bottom));
}
function Br(i) {
...
class Le extends ct {
  ...
  draw(t) {
    const { inflateAmount: e, options: { borderColor: s, backgroundColor: n } } = this, { inner: o, outer: r } = Er(this), a = Br(r.radius) ? ge : Hr;
    t.save(), (r.w !== o.w || r.h !== o.h) && (t.beginPath(), a(t, Ae(r, e, o)), t.clip(), a(t, Ae(o, -e, r)), t.fillStyle = s, t.fill("evenodd")), t.beginPath(), a(t, Ae(o, e)), t.fillStyle = n, t.fill(), t.restore();
  }
  inRange(t, e, s) {
    return Te(this, t, e, s);
  }
  inXRange(t, e) {
...
}, Wr = (i, t) => i !== null && t !== null && i.datasetIndex === t.datasetIndex && i.index === t.index;
class ji extends ct {
  constructor(t) {
  ...
  fit() {
    ...
    const s = t.labels, n = W(s.font), o = n.size, r = this._computeTitleHeight(), { boxWidth: a, itemHeight: l } = Ni(s, o);
    let c, h;
  ...
  _fitCols(t, e, s, n) {
    ...
    return this.legendItems.forEach((m, b) => {
      const { itemWidth: _, itemHeight: y } = Vr(s, e, o, m, n);
  ...
  adjustHitBoxes() {
    if (!this.options.display)
      return;
    const t = this._computeTitleHeight(), { legendHitBoxes: e, options: { align: s, labels: { padding: n }, rtl: o } } = this, r = St(o, this.left, this.width);
    if (this.isHorizontal()) {
      let a = 0, l = H(s, this.left + n, this.right - this.lineWidths[a]);
      for (const c of e)
        a !== c.row && (a = c.row, l = H(s, this.left + n, this.right - this.lineWidths[a])), c.top += this.top + t + n, c.left = r.leftForLtr(r.x(l), c.width), l += c.width + n;
    } else {
      let a = 0, l = H(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
      for (const c of e)
        c.col !== a && (a = c.col, l = H(s, this.top + t + n, this.bottom - this.columnSizes[a].height)), c.top = l, c.left += this.left + n, c.left = r.leftForLtr(r.x(c.left), c.width), l += c.height + n;
    }
  }
  isHorizontal() {
  ...
  draw() {
    if (this.options.display) {
      const t = this.ctx;
      Ve(t, this), this._draw(), Ne(t);
    }
  }
  _draw() {
    const { options: t, columnSizes: e, lineWidths: s, ctx: n } = this, { align: o, labels: r } = t, a = F.color, l = St(t.rtl, this.left, this.width), c = W(r.font), { padding: h } = r, d = c.size, u = d / 2;
    let f;
    this.drawTitle(), n.textAlign = l.textAlign("left"), n.textBaseline = "middle", n.lineWidth = 0.5, n.font = c.string;
    const { boxWidth: p, boxHeight: g, itemHeight: m } = Ni(r, d), b = function(k, M, w) {
      if (isNaN(p) || p <= 0 || isNaN(g) || g < 0)
        return;
      n.save();
      const S = A(w.lineWidth, 1);
      if (n.fillStyle = A(w.fillStyle, a), n.lineCap = A(w.lineCap, "butt"), n.lineDashOffset = A(w.lineDashOffset, 0), n.lineJoin = A(w.lineJoin, "miter"), n.lineWidth = S, n.strokeStyle = A(w.strokeStyle, a), n.setLineDash(A(w.lineDash, [])), r.usePointStyle) {
        const L = {
          radius: g * Math.SQRT2 / 2,
          pointStyle: w.pointStyle,
          rotation: w.rotation,
          borderWidth: S
        }, P = l.xPlus(k, p / 2), D = M + u;
        _s(n, L, P, D, r.pointStyleWidth && p);
      } else {
        const L = M + Math.max((d - g) / 2, 0), P = l.leftForLtr(k, p), D = Mt(w.borderRadius);
        n.beginPath(), Object.values(D).some((N) => N !== 0) ? ge(n, {
          x: P,
          y: L,
          w: p,
          h: g,
          radius: D
        }) : n.rect(P, L, p, g), n.fill(), S !== 0 && n.stroke();
      }
      n.restore();
    }, _ = function(k, M, w) {
      Ut(n, w.text, k, M + m / 2, c, {
    ...
    this.legendItems.forEach((k, M) => {
      ...
      const w = n.measureText(k.text).width, S = l.textAlign(k.textAlign || (k.textAlign = r.textAlign)), L = p + u + w;
      let P = f.x, D = f.y;
      l.setWidth(this.width), y ? M > 0 && P + L + h > this.right && (D = f.y += x, f.line++, P = f.x = H(o, this.left + h, this.right - s[f.line])) : M > 0 && D + x > this.bottom && (P = f.x = P + e[f.line].width + h, f.line++, D = f.y = H(o, this.top + v + h, this.bottom - e[f.line].height));
      const N = l.x(P);
      if (b(N, D, k), P = bn(S, P + p + u, y ? P + L : this.right, t.rtl), _(l.x(P), D, k), y)
        f.x += L + h;
        ...
        f.y += x;
    }), Os(this.ctx, t.textDirection);
  }
  drawTitle() {
    const t = this.options, e = t.title, s = W(e.font), n = X(e.padding);
    if (!e.display)
      return;
    const o = St(t.rtl, this.left, this.width), r = this.ctx, a = e.position, l = s.size / 2, c = n.top + l;
    let h, d = this.left, u = this.width;
    if (this.isHorizontal())
      u = Math.max(...this.lineWidths), h = this.top + c, d = H(t.align, d, this.right - u);
    else {
      const p = this.columnSizes.reduce((g, m) => Math.max(g, m.height), 0);
      h = c + H(t.align, this.top, this.bottom - p - t.labels.padding - this._computeTitleHeight());
    }
    const f = H(a, d, d + u);
    r.textAlign = o.textAlign(We(a)), r.textBaseline = "middle", r.strokeStyle = e.color, r.fillStyle = e.color, r.font = s.string, Ut(r, e.text, f, h, s);
  }
  _computeTitleHeight() {
    const t = this.options.title, e = W(t.font), s = X(t.padding);
  ...
  _getLegendItemAt(t, e) {
    ...
    if (wt(t, this.left, this.right) && wt(e, this.top, this.bottom)) {
      for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
        if (n = o[s], wt(t, n.left, n.left + n.width) && wt(e, n.top, n.top + n.height))
  ...
  handleEvent(t) {
    ...
    if (t.type === "mousemove" || t.type === "mouseout") {
      const n = this._hoveredItem, o = Wr(n, s);
      n && !o && z(e.onLeave, [
        t,
        n,
        this
...
function Vr(i, t, e, s, n) {
  const o = Nr(s, i, t, e), r = jr(n, s, t.lineHeight);
  return {
    itemWidth: o,
    itemHeight: r
  };
...
function jr(i, t, e) {
  let s = i;
  return typeof t.text != "string" && (s = Vs(t, e)), s;
}
function Vs(i, t) {
...
class Ns extends ct {
  ...
  _drawArgs(t) {
    ...
    let l = 0, c, h, d;
    return this.isHorizontal() ? (h = H(a, s, o), d = e + t, c = o - s) : (r.position === "left" ? (h = s + t, d = H(a, n, e), l = V * -0.5) : (h = o - t, d = H(a, e, n), l = V * 0.5), c = n - e), {
      titleX: h,
      titleY: d,
      maxWidth: c,
      rotation: l
...
const Bt = {
  ...
  nearest(i, t) {
    ...
    for (o = 0, r = i.length; o < r; ++o) {
      const l = i[o].element;
      if (l && l.hasValue()) {
        const c = l.getCenterPoint(), h = hn(t, c);
        h < n && (n = h, a = l);
      }
    }
    if (a) {
...
function $i(i, t) {
  const e = i.chart.ctx, { body: s, footer: n, title: o } = i, { boxWidth: r, boxHeight: a } = t, l = W(t.bodyFont), c = W(t.titleFont), h = W(t.footerFont), d = o.length, u = n.length, f = s.length, p = X(t.padding);
  let g = p.height, m = 0, b = s.reduce((v, x) => v + x.before.length + x.lines.length + x.after.length, 0);
  ...
  return e.save(), e.font = c.string, T(i.title, y), e.font = l.string, T(i.beforeBody.concat(i.afterBody), y), _ = t.displayColors ? r + 2 + t.boxPadding : 0, T(s, (v) => {
    T(v.before, y), T(v.lines, y), T(v.after, y);
  }), _ = 0, e.font = h.string, T(i.footer, y), e.restore(), m += p.width, {
    width: m,
    height: g
  };
}
...
function qr(i, t, e, s) {
  ...
  let c = "center";
  return s === "center" ? c = n <= (a + l) / 2 ? "left" : "right" : n <= o / 2 ? c = "left" : n >= r - o / 2 && (c = "right"), Xr(c, i, t, e) && (c = "center"), c;
}
function Ui(i, t, e) {
  const s = e.yAlign || t.yAlign || Yr(i, e);
  return {
    xAlign: e.xAlign || t.xAlign || qr(i, t, e, s),
    yAlign: s
  };
}
function Gr(i, t) {
...
function Ki(i, t, e, s) {
  const { caretSize: n, caretPadding: o, cornerRadius: r } = i, { xAlign: a, yAlign: l } = e, c = n + o, { topLeft: h, topRight: d, bottomLeft: u, bottomRight: f } = Mt(r);
  let p = Gr(t, a);
  const g = Qr(t, l, c);
...
function j(i, t, e, s) {
  ...
  return typeof n > "u" ? js[t].call(e, s) : n;
}
class Ee extends ct {
  constructor(t) {
  ...
  _resolveAnimations() {
    ...
    if (t)
      return t;
    const e = this.chart, s = this.options.setContext(this.getContext()), n = s.enabled && e.options.animation && s.animations, o = new Cs(this.chart, n);
    return n._cacheable && (this._cachedAnimations = Object.freeze(o)), o;
  }
  getContext() {
    return this.$context || (this.$context = Zr(this.chart.getContext(), this, this._tooltipItems));
  }
  getTitle(t, e) {
    const { callbacks: s } = e, n = j(s, "beforeTitle", this, t), o = j(s, "title", this, t), r = j(s, "afterTitle", this, t);
    let a = [];
    return a = J(a, st(n)), a = J(a, st(o)), a = J(a, st(r)), a;
  }
  getBeforeBody(t, e) {
    return Yi(j(e.callbacks, "beforeBody", this, t));
  }
  getBody(t, e) {
    ...
    return T(t, (o) => {
      ...
      J(r.before, st(j(a, "beforeLabel", this, o))), J(r.lines, j(a, "label", this, o)), J(r.after, st(j(a, "afterLabel", this, o))), n.push(r);
    }), n;
  }
  getAfterBody(t, e) {
    return Yi(j(e.callbacks, "afterBody", this, t));
  }
  getFooter(t, e) {
  ...
  _createItems(t) {
    ...
    for (l = 0, c = e.length; l < c; ++l)
      a.push(Kr(this.chart, e[l]));
    return t.filter && (a = a.filter((h, d, u) => t.filter(h, d, u, s))), t.itemSort && (a = a.sort((h, d) => t.itemSort(h, d, s))), T(a, (h) => {
      const d = Xi(t.callbacks, h);
  ...
  update(t, e) {
    ...
    if (!n.length)
      ...
      const a = Bt[s.position].call(this, n, this._eventPosition);
      r = this._createItems(s), this.title = this.getTitle(r, s), this.beforeBody = this.getBeforeBody(r, s), this.body = this.getBody(r, s), this.afterBody = this.getAfterBody(r, s), this.footer = this.getFooter(r, s);
      const l = this._size = $i(this, s), c = Object.assign({}, a, l), h = Ui(this.chart, s, c), d = Ki(s, c, h, this.chart);
  ...
  getCaretPosition(t, e, s) {
    const { xAlign: n, yAlign: o } = this, { caretSize: r, cornerRadius: a } = s, { topLeft: l, topRight: c, bottomLeft: h, bottomRight: d } = Mt(a), { x: u, y: f } = t, { width: p, height: g } = e;
    let m, b, _, y, v, x;
    return o === "center" ? (v = f + g / 2, n === "left" ? (m = u, b = m - r, y = v + r, x = v - r) : (m = u + p, b = m + r, y = v - r, x = v + r), _ = m) : (n === "left" ? b = u + Math.max(l, h) + r : n === "right" ? b = u + p - Math.max(c, d) - r : b = this.caretX, o === "top" ? (y = f, v = y - r, m = b - r, _ = b + r) : (y = f + g, v = y + r, m = b + r, _ = b - r), x = y), {
      x1: m,
      x2: b,
      x3: _,
      y1: y,
  ...
  drawTitle(t, e, s) {
    ...
    let r, a, l;
    if (o) {
      const c = St(s.rtl, this.x, this.width);
      for (t.x = ne(this, s.titleAlign, s), e.textAlign = c.textAlign(s.titleAlign), e.textBaseline = "middle", r = W(s.titleFont), a = s.titleSpacing, e.fillStyle = s.titleColor, e.font = r.string, l = 0; l < o; ++l)
        e.fillText(n[l], c.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + a, l + 1 === o && (t.y += s.titleMarginBottom - a);
    }
  }
  _drawColorBox(t, e, s, n, o) {
    const r = this.labelColors[s], a = this.labelPointStyles[s], { boxHeight: l, boxWidth: c } = o, h = W(o.bodyFont), d = ne(this, "left", o), u = n.x(d), f = l < h.lineHeight ? (h.lineHeight - l) / 2 : 0, p = e.y + f;
    if (o.usePointStyle) {
      const g = {
      ...
      t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, ci(t, g, m, b), t.strokeStyle = r.borderColor, t.fillStyle = r.backgroundColor, ci(t, g, m, b);
    } else {
      ...
      const g = n.leftForLtr(u, c), m = n.leftForLtr(n.xPlus(u, 1), c - 2), b = Mt(r.borderRadius);
  ...
  drawBody(t, e, s) {
    ...
    const p = St(s.rtl, this.x, this.width), g = function(w) {
      e.fillText(w, p.x(t.x + f), t.y + u / 2), t.y += u + o;
    }, m = p.textAlign(r);
    let b, _, y, v, x, k, M;
    for (e.textAlign = r, e.textBaseline = "middle", e.font = d.string, t.x = ne(this, m, s), e.fillStyle = s.bodyColor, T(this.beforeBody, g), f = a && m !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0, v = 0, k = n.length; v < k; ++v) {
      for (b = n[v], _ = this.labelTextColors[v], e.fillStyle = _, T(b.before, g), y = b.lines, a && y.length && (this._drawColorBox(e, t, v, p, s), u = Math.max(d.lineHeight, l)), x = 0, M = y.length; x < M; ++x)
        g(y[x]), u = d.lineHeight;
      T(b.after, g);
    }
    f = 0, u = d.lineHeight, T(this.afterBody, g), t.y -= o;
  }
  drawFooter(t, e, s) {
    const n = this.footer, o = n.length;
    let r, a;
    if (o) {
      const l = St(s.rtl, this.x, this.width);
      for (t.x = ne(this, s.footerAlign, s), t.y += s.footerMarginTop, e.textAlign = l.textAlign(s.footerAlign), e.textBaseline = "middle", r = W(s.footerFont), e.fillStyle = s.footerColor, e.font = r.string, a = 0; a < o; ++a)
        e.fillText(n[a], l.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + s.footerSpacing;
    }
  }
  drawBackground(t, e, s, n) {
    const { xAlign: o, yAlign: r } = this, { x: a, y: l } = t, { width: c, height: h } = s, { topLeft: d, topRight: u, bottomLeft: f, bottomRight: p } = Mt(n.cornerRadius);
  ...
  _updateAnimationTarget(t) {
    ...
    if (n || o) {
      const r = Bt[t.position].call(this, this._active, this._eventPosition);
      if (!r)
        return;
      const a = this._size = $i(this, t), l = Object.assign({}, r, this._size), c = Ui(e, t, l), h = Ki(t, l, c, e);
  ...
  draw(t) {
    ...
    e.enabled && a && (t.save(), t.globalAlpha = s, this.drawBackground(o, t, n, e), Ps(t, e.textDirection), o.y += r.top, this.drawTitle(o, t, e), this.drawBody(o, t, e), this.drawFooter(o, t, e), Os(t, e.textDirection), t.restore());
  }
  getActiveElements() {
    return this._active || [];
  }
  setActiveElements(t, e) {
    ...
    }), o = !he(s, n), r = this._positionChanged(n, e);
  ...
  handleEvent(t, e, s = !0) {
    ...
    const n = this.options, o = this._active || [], r = this._getActiveElements(t, o, e, s), a = this._positionChanged(r, t), l = e || !he(r, o) || a;
  ...
  _positionChanged(t, e) {
    const { caretX: s, caretY: n, options: o } = this, r = Bt[o.position].call(this, t, e);
...
const Jr = (i, t, e, s) => (typeof t == "string" ? (e = i.push(t) - 1, s.unshift({
  index: e,
  label: t
})) : isNaN(t) && (e = null), e);
function ta(i, t, e, s) {
...
const ea = (i, t) => i === null ? null : G(Math.round(i), 0, t);
function qi(i) {
...
class Gi extends Dt {
  ...
  parse(t, e) {
    if (I(t))
      return null;
    const s = this.getLabels();
    return e = isFinite(e) && s[e] === t ? e : ta(s, t, A(e, t), this._addedLabels), ea(e, s.length - 1);
  }
  determineDataLimits() {
...
O(Gi, "id", "category"), O(Gi, "defaults", {
  ticks: {
    callback: qi
  }
});
function ia(i, t) {
  const e = [], { bounds: n, step: o, min: r, max: a, precision: l, count: c, maxTicks: h, maxDigits: d, includeBounds: u } = i, f = o || 1, p = h - 1, { min: g, max: m } = t, b = !I(r), _ = !I(a), y = !I(c), v = (m - g) / (d + 1);
  let x = ti((m - g) / p / f) * f, k, M, w, S;
  if (x < 1e-14 && !b && !_)
    return [
      {
        value: g
  ...
  S = Math.ceil(m / x) - Math.floor(g / x), S > p && (x = ti(S * x / p / f) * f), I(l) || (k = Math.pow(10, l), x = Math.ceil(x * k) / k), n === "ticks" ? (M = Math.floor(g / x) * x, w = Math.ceil(m / x) * x) : (M = g, w = m), b && _ && o && rn((a - r) / o, x / 1e3) ? (S = Math.round(Math.min((a - r) / x, h)), x = (a - r) / S, M = r, w = a) : y ? (M = b ? r : M, w = _ ? a : w, S = c - 1, x = (w - M) / S) : (S = (w - M) / x, re(S, Math.round(S), x / 1e3) ? S = Math.round(S) : S = Math.ceil(S));
  const L = Math.max(ei(x), ei(M));
  k = Math.pow(10, I(l) ? L : l), M = Math.round(M * k) / k, w = Math.round(w * k) / k;
  let P = 0;
  for (b && (u && M !== r ? (e.push({
    value: r
  }), M < r && P++, re(Math.round((M + P * x) * k) / k, r, Qi(r, v, i)) && P++) : M < r && P++); P < S; ++P) {
    const D = Math.round((M + P * x) * k) / k;
    if (_ && D > a)
      break;
    e.push({
      value: D
  ...
  return _ && u && w !== a ? e.length && re(e[e.length - 1].value, a, Qi(a, v, i)) ? e[e.length - 1].value = a : e.push({
    value: a
  }) : (!_ || w === a) && e.push({
    value: w
  }), e;
}
function Qi(i, t, { horizontal: e, minRotation: s }) {
  const n = bt(s), o = (e ? Math.sin(n) : Math.cos(n)) || 1e-3, r = 0.75 * t * ("" + i).length;
...
class sa extends Dt {
  ...
  getLabelForValue(t) {
    return ms(t, this.chart.options.locale, this.options.ticks.format);
  }
}
class Zi extends sa {
  determineDataLimits() {
  ...
  computeTickLimit() {
    const t = this.isHorizontal(), e = t ? this.width : this.height, s = bt(this.options.ticks.minRotation), n = (t ? Math.sin(s) : Math.cos(s)) || 1e-3, o = this._resolveTickFontOptions(0);
...
O(Zi, "id", "linear"), O(Zi, "defaults", {
  ticks: {
    callback: bs.formatters.numeric
  }
});
const ye = {
  millisecond: {
...
function es(i, t, e, s) {
  ...
  for (let o = $.indexOf(i); o < n - 1; ++o) {
    const r = ye[$[o]], a = r.steps ? r.steps : Number.MAX_SAFE_INTEGER;
...
function na(i, t, e, s, n) {
  for (let o = $.length - 1; o >= $.indexOf(e); o--) {
    const r = $[o];
    if (ye[r].common && i._adapter.diff(n, s, r) >= t - 1)
      return r;
  }
...
function is(i, t, e) {
  if (!e)
    ...
    const { lo: s, hi: n } = He(e, t), o = e[s] >= t ? e[s] : e[n];
    i[o] = !0;
  }
}
function ra(i, t, e, s) {
...
class be extends Dt {
  ...
  init(t, e = {}) {
    const s = t.time || (t.time = {}), n = this._adapter = new So._date(t.adapters.date);
    n.init(e), Ht(s.displayFormats, n.formats()), this._parseOpts = {
      parser: s.parser,
      round: s.round,
  ...
  parse(t, e) {
    return t === void 0 ? null : ts(this, t);
  }
  beforeLayout() {
  ...
  buildTicks() {
    ...
    const o = this.min, r = this.max, a = gn(n, o, r);
    return this._unit = e.unit || (s.autoSkip ? es(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : na(this, a.length, e.minUnit, this.min, this.max)), this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : oa(this._unit), this.initOffsets(n), t.reverse && a.reverse(), ss(this, a, this._majorUnit);
  }
  afterAutoSkip() {
  ...
  initOffsets(t = []) {
    ...
    e = G(e, 0, r), s = G(s, 0, r), this._offsets = {
      start: e,
      end: s,
      factor: 1 / (e + 1 + s)
    };
  ...
  _generate() {
    const t = this._adapter, e = this.min, s = this.max, n = this.options, o = n.time, r = o.unit || es(o.minUnit, e, s, this._getLabelCapacity(e)), a = A(n.ticks.stepSize, 1), l = r === "week" ? o.isoWeekday : !1, c = fe(l) || l === !0, h = {};
    let d = e, u, f;
    ...
    for (u = d, f = 0; u < s; u = +t.add(u, a, r), f++)
      is(h, u, p);
    return (u === s || n.bounds === "ticks" || f === 1) && is(h, u, p), Object.keys(h).sort(Ji).map((g) => +g);
  }
  getLabelForValue(t) {
  ...
  _getLabelSize(t) {
    const e = this.options.ticks, s = this.ctx.measureText(t).width, n = bt(this.isHorizontal() ? e.maxRotation : e.minRotation), o = Math.cos(n), r = Math.sin(n), a = this._resolveTickFontOptions(0).size;
    return {
      w: s * o + a * r,
      h: s * r + a * o
    };
...
function oe(i, t, e) {
  ...
  e ? (t >= i[s].pos && t <= i[n].pos && ({ lo: s, hi: n } = Ie(i, "pos", t)), { pos: o, time: a } = i[s], { pos: r, time: l } = i[n]) : (t >= i[s].time && t <= i[n].time && ({ lo: s, hi: n } = Ie(i, "time", t)), { time: o, pos: a } = i[s], { time: r, pos: l } = i[n]);
  const c = r - o;
...
O(ns, "id", "timeseries"), O(ns, "defaults", be.defaults);
const $s = "label";
function os(i, t) {
...
function Ks(i, t) {
  let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : $s;
  const s = [];
  i.datasets = t.map((n) => {
...
function la(i) {
  ...
  return Us(e, i.labels), Ks(e, i.datasets, t), e;
}
function ca(i, t) {
  const { height: e = 150, width: s = 300, redraw: n = !1, datasetIdKey: o, type: r, data: a, options: l, plugins: c = [], fallbackContent: h, updateMode: d, ...u } = i, f = Ge(null), p = Ge(null), g = () => {
    f.current && (p.current = new qe(f.current, {
      type: r,
      data: la(a, o),
      options: l && {
        ...l
    ...
    os(t, null), p.current && (p.current.destroy(), p.current = null);
  };
  return kt(() => {
    !n && p.current && l && aa(p.current, l);
  }, [
    n,
    l
  ]), kt(() => {
    !n && p.current && Us(p.current.config.data, a.labels);
  }, [
    n,
    a.labels
  ]), kt(() => {
    !n && p.current && a.datasets && Ks(p.current.config.data, a.datasets, o);
  }, [
    n,
    a.datasets
  ]), kt(() => {
    p.current && (n ? (m(), setTimeout(g)) : p.current.update(d));
  }, [
    n,
    l,
    a.labels,
    ...
    r
  ]), kt(() => (g(), () => m()), []), /* @__PURE__ */ rs.createElement("canvas", {
    ref: f,
    role: "img",
    height: e,
    width: s,
...
const ha = /* @__PURE__ */ as(ca);
function da(i, t) {
  return qe.register(t), /* @__PURE__ */ as((e, s) => /* @__PURE__ */ rs.createElement(ha, {
    ...e,
    ref: s,
    type: i
  }));
}
const xa = /* @__PURE__ */ da("bar", ae);
export {
  xa as B,
  qe as C,
  Zi as L,
